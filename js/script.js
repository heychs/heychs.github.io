(function($) {
    ...
    function preloader() {
        if($('.preloader').length) {
            $('.preloader').delay().fadeOut(100, function() {
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2019/01/26', function(event) {
            var $this = $(this).html(event.strftime(''
            + '<div class="box"><div>%D</div> <span>일</span> </div>'
            + '<div class="box"><div>%H</div> <span>시간</span> </div>'
            + '<div class="box"><div>%M</div> <span>분</span> </div>'
            + '<div class="box"><div>%S</div> <span>초</span> </div>'));
        });
    }
